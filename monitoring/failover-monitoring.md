...
| Alert Type                     | Captures Automatic Failover | Captures Manual Failover | Real-time Detection | Primary Use Case                      |
| ------------------------------ | --------------------------- | ------------------------ | ------------------- | ------------------------------------- |
| **Azure Service Health**       | Yes                         | No                       | No                  | Broad outage awareness, exec comms    |
| **Azure Activity Log Alerts**  | Yes                         | Yes                      | Yes                 | Primary detection mechanism, on-call alerting |
| **Azure Monitor Logs**         | Indirectly                  | Indirectly               | No                  | RCA, forensics, analytics            |
| **Metric-based Alerts**        | Indirectly                  | Indirectly               | Yes                 | Customer impact detection            |
| **Client-side Detection (SDK)** | Indirectly                  | Indirectly               | Yes                 | Supplemental telemetry               |
